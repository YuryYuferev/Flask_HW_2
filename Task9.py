# На Flask cоздать страницу, на которой будет форма для ввода имени и электронной почты
...
def get_users_data() -> dict:
    return {
            'admin@mail.ru': ['password_1', 'admin'],
            'user@gmail.com': ['password_2', 'user'],
            'John@yandex.com': ['password_3', 'John'],
        }
